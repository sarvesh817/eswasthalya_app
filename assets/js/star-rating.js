...
(function (factory) {
    ...
    $.fn.rating.defaults = {
        ...
        starCaptionClasses: {
            ...
            4.5: 'label label-warning badge-warning',
            5: 'label label-primary badge-primary',            
            5.5: 'label label-primary badge-primary',
            6: 'label label-primary badge-primary',
            6.5: 'label label-primary badge-primary',
            7: 'label label-primary badge-primary',
            7.5: 'label label-primary badge-primary',
            8: 'label label-success badge-success',
