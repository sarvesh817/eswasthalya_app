                ...
                $("#appointment_list > tbody").append(
                    ...
                    <tr>
                        ...
                        <td class="text-center align-middle">
                            ...
                            <button class="btn btn-danger btn-sm " onclick="delete_appointment(${element.id})" data-bs-toggle="modal" data-bs-target="#deletestaticBackdrop"><i class="fas fa-trash"></i></button>
                        </td>
                    </tr>
                    `
                );
