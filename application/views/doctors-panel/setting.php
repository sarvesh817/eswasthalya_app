<?php 
    ...
    $doctorCode = "DR-".str_pad($userid, 5, "0", STR_PAD_LEFT);
...
<div class="page-body px-xl-4 px-sm-2 px-0 py-lg-2 py-1 mt-0 mt-lg-3">
                ...
                <div class="row g-3">
                  <div class="col-lg-4 col-md-12">
                    <div class="form-group">
                      <input type="text" class="form-control" value="<?php echo  $doctorCode; ?>" readonly placeholder="Username">
  ...
  <div class="modal fade" id="donepopup" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
    ...
    // WX05181
        ...
        /*$("#frm_forgot_pwd").ajaxSubmit({
              url: '<?php echo base_url();?>login/forgotpassword',
              type: 'post',
              dataType: 'json',
              success: function (response) {          
                if(response.success){
                  $(".show_msg").html('<span style="color:green;">'+response.msg+'</span>');
                  location.reload();            
                }
                else{
...
*/
  ...
  <script src="<?php echo base_url() ?>bassets/js/theme.js"></script>
    ...
    <script>
        ...
        var URLss = "<?=base_url('doctors/setting')?>";
        ...
        $(document).ready(function(){
        	...
        	function Role_validate(){
        		...
        		if(new_password == ''){
        			$('#new_passworderr').html("<font style='color:red'><b>Enter New Password</b></font>");
        			return false;
        		}
