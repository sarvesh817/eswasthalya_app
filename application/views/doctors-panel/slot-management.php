          ...
          <div class="col-xl-12 col-lg-12 col-md-12">
                        ...
                        <div class="row mb-2">
                         <!--  <div class="calendar col-md-8 offset-md-2">
                              <div>
                                 ...
                                 <center> <div    id="datepicker1"></div></center> 
           ...
           <div class="row mt-2">
              ...
              <div class="col offset-md-1">
                  ...
                  <table    class="table table-bordered table-hover table-striped table-sm" id="appointment_listsss">
...
<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script> 
  ...
  $('#datepicker1').datepicker({
    onSelect: function(date){
      ...
      var selected_date=dayNames[d];     
      var future_date=$('#datepicker1').val(); 
      if(selected_date){         
              $.ajax({
              url:"<?php echo base_url(); ?>doctors/fetch-dependent-datewise-data",      
              method:"POST",
              data:{selected_date:selected_date,future_date:future_date},
