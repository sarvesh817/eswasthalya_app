    ...
    <div class="page-toolbar px-xl-4 px-sm-2 px-0 py-3">
      <div class="container-fluid">
        ...
        <div class="row align-items-center">
          <div class="col-auto">
            <h1 class="fs-5 color-900 mt-1 mb-0">Welcome back, Dr. <?php echo $this->session->userdata('first_name').' '.$this->session->userdata('last_name'); ?>!</h1>
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                      <div class="col-sm-5 mb-4">
                        ...
                        <input type="submit" name="submit_schedule" value="<?=$submit_val?>" class="btn btn-primary w-auto">  
