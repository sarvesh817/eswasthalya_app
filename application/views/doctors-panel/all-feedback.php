            ...
            <div class="card">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-sm-6">
                      <div class="btn-right">
                          <a href="<?=base_url('doctors/add-feedback')?>" class="btn btn-primary">+ Add Feedback</a>
                      </div>
                  </div>
              </div>
                <table id="feedbackTable" class="table card-table table-hover align-middle mb-0 feedback_table">
                 ...
                 foreach($feedback_list as $wl) { ?>
                    ...
                    <td><?php echo $i++;?></td>
                      ...
                      <td>
                        <a href="<?=base_url('doctors/add-feedback')?>?id=<?php echo $wl['id'] ?>" class="btn btn-secondary modal-btn" data-bs-toggle="tooltip" title="Edit"><i class="bi bi-pen"></i></a>
        ...
        $(document).ready(function(){
	        $('.deleteBTn').click(function(){
	            ...
	            $('#deleteyesBTN').click(function(){
	                ...
	                $.ajax({
        				url:'<?=base_url('Feedback/delete_feedback')?>',
        				method:'post',
        				data:{id:id},
        				dataType:'json',
