        ...
        <div class="row g-0">
          ...
          <div class="col-lg-6 d-flex justify-content-center align-items-center">
            <div class="card shadow-sm w-100 p-4 p-md-5" style="max-width: 32rem;">
              <!-- Form -->
              <form class="row g-3" action="<?=base_url('loginNow')?>" id="form-validate" method="post" enctype="multipart/form-data"> 
                ...
                <div class="col-12 text-center mb-4">
                  <a class="btn btn-lg btn-outline-secondary btn-block" href="#">
                    <span class="d-flex justify-content-center align-items-center">
                      <img class="avatar xs me-2" src="<?php echo base_url() ?>bassets/img/google.svg" alt="Image Description"> Sign in with Google </span>
                  </a>
                  <span class="dividers text-muted mt-2">OR</span>
                ...
                <div class="col-12 text-center mt-4">
                  <span class="text-muted">Don't have an account yet? <a href="<?=base_url('user-register')?>">Sign up here</a></span>
                </div>
              </form>
              <!-- End Form -->
            </div>    
